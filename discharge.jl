...
function discharge(EP::Model, inputs::Dict, EnergyShareRequirement::Int)
	...
	# NEW_CO2_TAX: the variable costs associated with the CO2 tax are added here to the variable cost expression.

	@expression(EP, eCVar_out[y=1:G,t=1:T], (inputs["omega"][t]*(dfGen[!,:Var_OM_Cost_per_MWh][y]+inputs["C_Fuel_per_MWh"][y,t]+dfGen[!,:CO2_Tax_per_MWh][y])*vP[y,t]))
